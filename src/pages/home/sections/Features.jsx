        ...
        <Reveal>
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="mt-2 text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed">
              We combine modern technologies, innovative thinking, and
              customer-focused development to deliver reliable digital solutions
            ...
            <Reveal key={index} delay={index * 150}>
              ...
              >
                ...
                <div
                  ...
                  "
                >
                  <h4 className="text-xl font-bold mb-6">What We Deliver</h4>
                  ...
                  <div className="mt-8 pt-6 border-t border-white/20">
                    <p className="text-white/90 text-sm leading-relaxed">
                      ...
                      scalability, security, performance, and long-term business
                      growth.
                    </p>
                  </div>
                </div>
