          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-500 text-lg">
                Explore how we've helped diverse clients achieve their digital
                goals.
              </p>
            </div>
              ...
              <div className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-xl mb-6 aspect-[4/3] border border-slate-200 shadow-lg bg-slate-100">
                  ...
                  <div className="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-sm">
                    <span className="text-white font-bold text-lg border-b-2 border-primary-400 pb-1 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                      View Case Study
                    </span>
                  </div>
                </div>
                <div className="pl-1">
                  <span className="text-primary-600 text-xs font-bold uppercase tracking-widest block mb-2">
                    {item.category}
                  </span>
