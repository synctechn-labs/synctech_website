  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 mb-20 text-center relative z-10">
        <Reveal>
          <h2 className="text-3xl md:text-5xl font-extrabold mb-8 tracking-tight text-slate-900">
            ...
            <Reveal>
              <div>
                ...
                <p className="text-slate-500 mb-8">
                  Fill out the form or reach us directly. We respond within 24
                  hours.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-sm">
                        101 Tech Blvd, Silicon Valley, CA
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 rounded-lg bg-slate-50 border border-slate-200 text-slate-900 focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all placeholder-slate-400"
