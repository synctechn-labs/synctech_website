...
import { Code2, Smartphone, Globe, BrainCircuit } from "lucide-react";
        ...
        <Reveal>
          <div className="max-w-4xl mx-auto text-center mb-24">
            ...
            <p className="mt-8 text-lg md:text-xl text-slate-600 leading-relaxed">
              SyncTech Software Solutions helps startups, businesses, and
              enterprises build scalable software, web applications, mobile
              apps, and AI-powered systems that accelerate growth and improve
              efficiency.
            </p>
          </div>
        </Reveal>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  <p className="text-2xl font-extrabold bg-gradient-to-r from-slate-800 via-blue-500 to-slate-500 bg-clip-text text-transparent leading-tight">
                    Leading Software Development Company for Web, Mobile and AI
                    Solutions
                  </p>
                </div>
              </div>
            ...
            {features.map((item, index) => {
              ...
              return (
                <Reveal key={index} delay={index * 150}>
                  {" "}
                  <div
                    className={` group relative h-[360px] overflow-hidden rounded-3xl bg-gradient-to-br ${item.gradient} backdrop-blur-xl border border-blue-100 shadow-[0_20px_60px_rgba(59,130,246,0.12)] transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_30px_80px_rgba(59,130,246,0.25)] ${index === 0 ? "mr-52" : ""} ${index === 1 ? "ml-52" : ""} ${index === 2 ? "mr-52 mt-32" : ""} ${index === 3 ? "ml-52 mt-32" : ""} `}
                  >
                    {" "}
                    {/* Front Side */}{" "}
                    <div className=" absolute inset-0 z-10 flex flex-col items-center justify-center text-center p-10 transition-all duration-500 group-hover:-translate-y-full group-hover:opacity-0 ">
                      {" "}
                      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center mb-6 shadow-lg">
                        {" "}
                    ...
                    {/* Hover Side */}{" "}
                    <div className=" absolute inset-0 z-20 bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 p-8 text-white translate-y-full group-hover:translate-y-0 transition-all duration-500 flex flex-col justify-center ">
                      {" "}
              ...
              return (
                <Reveal key={index}>
                  <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-lg">
                    ...
                    <p className="text-slate-500 mt-2">{item.subtitle}</p>
