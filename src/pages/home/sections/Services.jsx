        ...
        <Reveal>
          <div className="mb-20 max-w-5xl mx-auto text-center">
            ...
            <p className="text-slate-600 text-lg md:text-xl max-w-4xl leading-relaxed">
              SyncTech Software Solutions provides custom software development,
              web applications, mobile app development, AI-powered solutions,
              cloud services, and digital transformation strategies that help
              businesses accelerate growth and achieve long-term success.
            </p>
          </div>
        </Reveal>
          ...
          {SERVICES.map((service, index) => (
            <Reveal key={service.id} delay={index * 100}>
              ...
              >
                ...
                <span className="text-6xl font-bold text-slate-100 absolute -top-8 right-0 -z-10">
                  0{index + 1}
                </span>
        ...
        <div className="space-y-24">
          {SERVICES.map((service, index) => (
            <div
              ...
              className={`relative group/section flex flex-col ${index % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row"} items-center gap-12 lg:gap-16 scroll-mt-24`}
            >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-8">
                      <h4 className="font-bold text-slate-900 text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                        <Layers size={16} className="text-primary-500" /> Core
                        Features
                      </h4>
                      <div className="flex flex-wrap gap-3">
                        {service.features.map((feature, i) => (
                          <span
                            key={i}
                            className="px-4 py-2 rounded-lg bg-white border border-slate-200 text-slate-600 text-sm font-medium hover:border-primary-300 hover:text-primary-700 hover:shadow-sm transition-all cursor-default"
                          >
                            {feature}
                          </span>
                        ))}
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm mb-8">
                      <h4 className="font-bold text-slate-900 text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                        <Check size={16} className="text-green-500" /> Key
                        Benefits
                      </h4>
