  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {(activeCategoryIndex > -1 || isFinalScene) &&
          [...Array(10)].map((_, i) => (
            <motion.div
              key={i}
                ...
                <AnimatePresence mode="popLayout">
                  {categories[activeCategoryIndex].techs.map((tech, idx) => {
                    ...
                    return (
                      ...
                      >
                        {isActive && (
                          <div className="absolute inset-0 bg-gradient-to-b from-indigo-50/50 to-transparent rounded-[24px]" />
                        )}
                        ...
                        <h4 className="text-2xl font-extrabold text-[#0F172A] relative z-10 tracking-tight">
                          {tech.name}
                        </h4>
                      </motion.div>
                    );
