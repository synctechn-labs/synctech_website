...
const sections = [
...

  {
    ...
    points: ["Jurisdiction: Chennai, Tamil Nadu.", "Applicable Indian laws."],
  },
              ...
              <ul className="space-y-2">
                {sections.map((section, index) => (
                  <li key={index}>
                    ...
                    >
                      <span
                        className={`w-2 h-2 rounded-full shrink-0 mt-1.5 ${activeSection === section.id ? "bg-blue-600" : "bg-slate-300"}`}
                      />
                      {section.title}
                    </a>
                  </li>
            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
                  Questions About Our
                  <span className="block text-blue-600">Terms of Service?</span>
                </h2>

                <p className="text-slate-600 max-w-2xl leading-relaxed">
                  If you have any questions regarding our Terms of Service,
                  please reach out to our team. We are happy to assist you with
                  any legal, compliance, or service-related inquiries.
                </p>
              </div>
