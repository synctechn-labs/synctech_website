            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
                  Questions About Our
                  <span className="block text-blue-600">Cookies Policy?</span>
                </h2>

                <p className="text-slate-600 max-w-2xl leading-relaxed">
                  If you have any questions regarding our Cookies Policy, cookie
                  usage, or privacy practices, please contact our team. We are
                  happy to assist you.
                </p>
              </div>
